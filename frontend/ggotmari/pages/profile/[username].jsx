  ...
  return (
    <>
      ...
      {windowInnerWidth > 600 && (
        <div className="labtop grid grid-cols-2 h-96">하이하아</div>
      )}
      {windowInnerWidth <= 600 && windowInnerWidth > 0 && (
        <>
          ...
          {activeTab === 0 && (
            <div
              className={
                "content grid grid-cols-3 mt-3 mb-14 gap-x-2 gap-y-2 mx-3"
              }
            >
          ...
          {activeTab === 2 && (
            <div className="content grid grid-cols-3 gap-x-2 gap-y-2 mt-3 mb-14  mx-3">
